...
| Модерация | Yandex Vision + стоп-слова + запрещённые товары | ✅ на сервере (`vision.mock:false`); `deploy/VISION.md` |
...
- **Модерация (фото):** Yandex Vision — moderation + OCR ✅ на сервере (`PHOTO_MOCK_MODERATION=false`, health `vision.ready:true`)
...
6. ✅ Модерация: стоп-слова ✅ + запрещённые товары ✅ + оферта 10.8 ✅; Vision ✅ (сервер 23.06.2026)
...
| **F — Модерация** | Запрещённые товары ✅; оферта 10.8 ✅; Yandex Vision ✅ (сервер 23.06.2026) | ✅ |
