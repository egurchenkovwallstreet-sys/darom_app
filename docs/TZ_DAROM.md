...
**Оценка прогресса (22.06.2026):** ядро MVP ~**99%** | полное ТЗ ~**68%**. Подробности: `docs/PROGRESS.md`.

## 12. Следующие этапы (приоритет)

| Этап | Задачи | Статус |
|------|--------|--------|
| **C — Монетизация** | Робокасса ⏸ (одобрение); SMS Aero ✅; Mobile ID ✅; SMTP ✅; Firebase push ✅ | ⏳ **текущий** |
| **D — Магазины** | Сборка Android APK / iOS, публикация | ⏳ |
| **E — Уведомления** | Firebase push (бронь, чаты, сделки) | ✅ **протестировано** |
| **F — Модерация** | Yandex Vision для фото | ⏳ **следующий** |
