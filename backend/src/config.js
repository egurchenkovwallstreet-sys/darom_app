...
const config = {
  ...
  robokassa: {
    ...
    password1: (process.env.ROBOKASSA_PASSWORD1 || '').trim(),
    password2: (process.env.ROBOKASSA_PASSWORD2 || '').trim(),
    testPassword1: (process.env.ROBOKASSA_TEST_PASSWORD1 || '').trim(),
    testPassword2: (process.env.ROBOKASSA_TEST_PASSWORD2 || '').trim(),
