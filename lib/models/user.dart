class User {
  ...
  const User({
    ...
    this.listingLimit = 30,
    this.baseListingLimit = 30,
    this.activeListings = 0,
    this.itemsGiven = 0,
    this.itemsTaken = 0,
    this.pickupLimit = 5,
    this.pickupsUsedThisMonth = 0,
    this.pickupsFreeRemaining = 5,
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      listingLimit: _toInt(json['listing_limit'], fallback: 30),
      baseListingLimit: _toInt(json['base_listing_limit'], fallback: 30),
      activeListings: _toInt(json['active_listings']),
      itemsGiven: _toInt(json['items_given']),
      itemsTaken: _toInt(json['items_taken']),
      pickupLimit: _toInt(json['pickup_limit'], fallback: 5),
      pickupsUsedThisMonth: _toInt(json['pickups_used_this_month']),
      pickupsFreeRemaining: _toInt(json['pickups_free_remaining'], fallback: 5),
