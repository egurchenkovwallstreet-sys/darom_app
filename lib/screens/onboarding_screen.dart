  ...
  final List<Map<String, dynamic>> _pages = [
    {
      ...
      'description':
          'В каждом доме лежит то, что может обрадовать другого человека. «Даром» — место, где добро становится простым и близким.',
    },
    {
      'icon': Icons.favorite,
      ...
      'description':
          'Не нужно быть богатым или известным. Достаточно одной вещи и одного доброго «возьмите, пусть послужит» — и вы уже помогаете по-настоящему.',
    },
    {
      ...
      'description':
          'Откройте приложение, отдайте лишнее или заберите нужное у соседа — бесплатно. Не выбросите — подарите. Так мир становится чуть теплее.',
    },
  ];
